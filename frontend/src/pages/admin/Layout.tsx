        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start md:justify-end">
              ...
              <a href="https://flowbite.com" className="flex ml-2 md:ml-24">
                <img
            ...
            <div className="flex items-center ml-3 relative">
              <div className="relative">
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 z-50 mt-2 text-base bg-white divide-y divide-gray-100 rounded shadow top-full">
                    ...
                    <ul className="py-1">
                      <li onClick={logoutHandler} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">
                          logout
                      </li>
                    </ul>
                  </div>
